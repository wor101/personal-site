      ...
      <div className="flex place-content-center min-h-screen bg-white">
        <div className="flex flex-col max-w-7xl px-7 my-24 space-y-4">
          ...
          {/* <div className="space-y-2 mx-4">
            <p>Core Space is a miniatures tabletop game designed by <a href="https://battlesystems.co.uk/" className="text-blue-500 hover:text-blue-900">Battle Systems</a>.</p>

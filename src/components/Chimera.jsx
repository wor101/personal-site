    ...
    <div id="chimera" className="flex place-content-center min-h-screen bg-white">
      <div className="flex flex-wrap md:flex-nowrap place-content-center items-center max-w-7xl px-7 py-7">
        ...
        <div className="flex flex-col px-6 py-6 space-y-4">
          ...
          <p className="text-lg">An open-source tool for performing automated canary deployments of containerized microservices.</p>
          <p className="text-lg">It allows software development teams to safely and easily deploy new versions of their microservices by taking advantage of the features provided by their existing service mesh</p>
